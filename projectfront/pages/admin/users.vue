  ...
  methods: {
    ...
    creditMetrics(user) {
      return [
        ...
        { label: '起名退款', value: user.total_refund },
        ...
        { label: 'Logo 退款', value: user.logo_total_refund }
      ]
    },
...
@media (min-width: 1280px) {
  ...
  .metrics-cell { grid-template-columns: repeat(8,1fr); margin-top: 0; padding: 8rpx 0; }
