...
from core.platform_auth import DeveloperAuth, api_key_digest, issue_api_key
from models.platform_models import DeveloperAccount
from repository.platform_repo import PlatformConflict, PlatformRepository, request_hash
from schemas.platform_schemas import BatchCreateIn, CampaignIn, DeveloperRegisterIn
...
class PlatformSecurityTests(unittest.TestCase):
    ...
    def test_developer_token_has_separate_audience(self):
        ...
        with patch("core.platform_auth.settings.JWT_SECRET_KEY", secret):
